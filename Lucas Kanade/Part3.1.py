...
#subtrackt background from iamge 
...
def track(frames, frames_2):
    ...
    for i in range(1, len(frames)):
        ...
        temp,track_points = Lucas_Kanade(frame0, frame1, track_points,1)
...
clip.write_videofile(str(d) + "/HW4/part3.mp4", codec='libx264')

with open(str(d) + "/HW4/part3_vectors", "wb") as f:
